    ...
    this.keywords = {
      ...
      properties (value, data) {
        ...
        Object.keys(data.value).forEach((prop) => {
          if (value.hasOwnProperty(prop)) {
            ...
            const genericPropInstance = new GenericPropType(property, this.generic)
      ...
      patternProperties (value, data) {
        ...
        if (additionalProperties.length) {
          ...
          for (let pattern of patterns) {
            ...
            const validator = new GenericPattern(entry, this.generic)
            let errors = []
      ...
      additionalProperties (value, data) {
        if (value === false) {
          ...
          const validator = new GenericAddType(value, this.generic)
