...
const parseValidationSuccess = (result) => {
...
const validate = function (data) {
  ...
  if (result instanceof Promise) {
    return result
      .then(validateKeywords(this._promisedKeywords, data))
  ...
  return validateKeywords(this._promisedKeywords, data)
    .then(parseValidationSuccess)
    .catch(parseValidationError)
}
